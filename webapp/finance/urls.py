...
urlpatterns = (
    ...
    url(r'^pay/transaction/callback/$', views.PaymentWebHook.as_view(), name="finance.callback"),


    # Admin views
    url(r'^admin/(?P<year>[0-9]+)/specified/$', RedirectView.as_view(pattern_name='finance.admin.year.overview', permanent=True)),
