...
urlpatterns = (
    ...
    path("register/thanks/", views.RegisterThanksView.as_view(), name="register_thanks"),
    ...
    path("passwordreset/", views.RequestPasswordResetView.as_view(), name="password_reset"),
    path("passwordreset/done/", views.PasswordResetRequestDoneView.as_view()),
    path("passwordreset/finished/", views.PasswordResetFinishedView.as_view()),
